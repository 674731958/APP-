			    ...
			    <ul>
					...
					<li>
						<div class="form-group">
							...
							<div class="col-md-6 col-sm-6 col-xs-12">
								<select name="queryFlatformId" class="form-control" value="">
					...
					<li>
						<div class="form-group">
							...
							<div class="col-md-6 col-sm-6 col-xs-12">
								<select id="queryCategoryLevel1" name="queryCategoryLevel1" class="form-control" value="${queryCategoryLevel1}">
				...
				<div class="row">
					<div class="col-sm-5">
						<div class="dataTables_info" id="datatable-responsive_info"
							...
							${ye}/${totalPage }页</div>
							<a href='list.do?ye=1&querySoftwareName=${querySoftwareName}&queryFlatformId=${queryFlatformId }&queryCategoryLevel1=${queryCategoryLevel1 }&queryCategoryLevel1=${queryCategoryLevel2}&queryCategoryLevel3=${queryCategoryLevel3 }'>首页</a>
							<a href='list.do?ye=${ye>=totalPage?totalPage:ye+1}&querySoftwareName=${querySoftwareName}&queryFlatformId=${queryFlatformId }&queryCategoryLevel1=${queryCategoryLevel1 }&queryCategoryLevel1=${queryCategoryLevel2}&queryCategoryLevel3=${queryCategoryLevel3 }'>下一页</a>
							<a href='list.do?ye=${ye<=1?1:ye-1 }&querySoftwareName=${querySoftwareName}&queryFlatformId=${queryFlatformId }&queryCategoryLevel1=${queryCategoryLevel1 }&queryCategoryLevel1=${queryCategoryLevel2}&queryCategoryLevel3=${queryCategoryLevel3 }'>上一页</a>
							<a href='list.do?ye=${totalPage}&querySoftwareName=${querySoftwareName}&queryFlatformId=${queryFlatformId }&queryCategoryLevel1=${queryCategoryLevel1 }&queryCategoryLevel1=${queryCategoryLevel2}&queryCategoryLevel3=${queryCategoryLevel3 }'>末页</a>
					</div>
					<div class="col-sm-7">						
...
<script type="text/javascript">
	$(document).ready(function(){
		$("#queryCategoryLevel1").change(function(){
			var queryCategoryLevel1=$(this).val();
			var options="<option value='0'>请选择</option>";
			$("#queryCategoryLevel2").html("");
			$.getJSON("dev/categorylevellist.do",{"queryCategoryLevel1":queryCategoryLevel1},function(data){
				$(data).each(function(){
		...
		$("#queryCategoryLevel2").change(function(){
			var queryCategoryLevel2=$(this).val();
			var options="<option value='0'>请选择</option>";
			$("#queryCategoryLevel3").html("");
			$.getJSON("dev/categorylevellist2.do",{"queryCategoryLevel2":queryCategoryLevel2},function(data){
				$(data).each(function(){
					options+="<option value="+this.id+">"+this.categoryName+"</option>";
				});
		...
		$("[type=button]").click(function(){
			...
			//可以进入审核
			if(status=="1"&&versionId!=""&&versionId!=null){
				window.location.href="check.do?id="+id+"&versionId="+versionId+"&appId="+appId;
			}
			else if(versionId==null||versionId==""){
				alert("未上传最新版本，不能进行审核");
			}else if(status!="1"){
				aler("该APP应用的状态为:"+statusName+",不能进行审核");
				}
		});
	});
</script>